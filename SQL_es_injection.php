...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #7289da;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="/Project_2020/SQL_es_injection.php">SQL Escape String injection<span class="sr-only">(current)</span></a>
        ...
        <center><br><br><br>
        <div class=container>
            <form name="login_form" action="/Project_2020/SQL_es_injection_login.php" method="post">
